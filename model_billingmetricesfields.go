...
type Billingmetricesfields struct {
	...
	TerminateTime *time.Time `json:"terminate_time,omitempty"`
...
// SetTerminateTime gets a reference to the given time.Time and assigns it to the TerminateTime field.
