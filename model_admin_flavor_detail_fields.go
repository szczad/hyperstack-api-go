...
// checks if the AdminFlavorDetailFields type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdminFlavorDetailFields{}

// AdminFlavorDetailFields struct for AdminFlavorDetailFields
type AdminFlavorDetailFields struct {
	...
	Nodes []AdminFlavorDetailNodeFields `json:"nodes,omitempty"`
...
func (o *AdminFlavorDetailFields) GetNodes() []AdminFlavorDetailNodeFields {
	if o == nil || IsNil(o.Nodes) {
		var ret []AdminFlavorDetailNodeFields
		return ret
	}
	return o.Nodes
}
...
// SetNodes gets a reference to the given []AdminFlavorDetailNodeFields and assigns it to the Nodes field.
...
func (o AdminFlavorDetailFields) MarshalJSON() ([]byte, error) {
...
func (o AdminFlavorDetailFields) ToMap() (map[string]interface{}, error) {
...
type NullableAdminFlavorDetailFields struct {
	value *AdminFlavorDetailFields
	isSet bool
}

func (v NullableAdminFlavorDetailFields) Get() *AdminFlavorDetailFields {
	return v.value
}

func (v *NullableAdminFlavorDetailFields) Set(val *AdminFlavorDetailFields) {
	v.value = val
	v.isSet = true
}

func (v NullableAdminFlavorDetailFields) IsSet() bool {
	return v.isSet
}

func (v *NullableAdminFlavorDetailFields) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdminFlavorDetailFields(val *AdminFlavorDetailFields) *NullableAdminFlavorDetailFields {
	return &NullableAdminFlavorDetailFields{value: val, isSet: true}
}

func (v NullableAdminFlavorDetailFields) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdminFlavorDetailFields) UnmarshalJSON(src []byte) error {
	v.isSet = true
