...
`func (o *PaymentDetailsFields) GetUpdatedAt() string`

GetUpdatedAt returns the UpdatedAt field if non-nil, zero value otherwise.

### GetUpdatedAtOk

`func (o *PaymentDetailsFields) GetUpdatedAtOk() (*string, bool)`
...
`func (o *PaymentDetailsFields) SetUpdatedAt(v string)`
