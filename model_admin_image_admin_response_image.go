...
// checks if the AdminImageAdminResponseImage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdminImageAdminResponseImage{}

// AdminImageAdminResponseImage struct for AdminImageAdminResponseImage
type AdminImageAdminResponseImage struct {
...
type _AdminImageAdminResponseImage AdminImageAdminResponseImage
...
func NewAdminImageAdminResponseImage(organizations []int32) *AdminImageAdminResponseImage {
	this := AdminImageAdminResponseImage{}
...
func (o AdminImageAdminResponseImage) MarshalJSON() ([]byte, error) {
...
func (o AdminImageAdminResponseImage) ToMap() (map[string]interface{}, error) {
...
func (o *AdminImageAdminResponseImage) UnmarshalJSON(data []byte) (err error) {
	...
	varAdminImageAdminResponseImage := _AdminImageAdminResponseImage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAdminImageAdminResponseImage)

	if err != nil {
		return err
	}

	*o = AdminImageAdminResponseImage(varAdminImageAdminResponseImage)

	return err
}

type NullableAdminImageAdminResponseImage struct {
	value *AdminImageAdminResponseImage
	isSet bool
}

func (v NullableAdminImageAdminResponseImage) Get() *AdminImageAdminResponseImage {
	return v.value
}

func (v *NullableAdminImageAdminResponseImage) Set(val *AdminImageAdminResponseImage) {
	v.value = val
	v.isSet = true
}

func (v NullableAdminImageAdminResponseImage) IsSet() bool {
	return v.isSet
}

func (v *NullableAdminImageAdminResponseImage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdminImageAdminResponseImage(val *AdminImageAdminResponseImage) *NullableAdminImageAdminResponseImage {
	return &NullableAdminImageAdminResponseImage{value: val, isSet: true}
}

func (v NullableAdminImageAdminResponseImage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdminImageAdminResponseImage) UnmarshalJSON(src []byte) error {
	v.isSet = true
