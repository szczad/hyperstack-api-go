...
/*
PostUser POST: Insert user info
...
func (r ApiUpdateUserInfoRequest) Payload(payload Userinfopostpayload) ApiUpdateUserInfoRequest {
	r.payload = &payload
	return r
}

func (r ApiUpdateUserInfoRequest) Execute() (*AddUserInfoSuccessResponseModel, *http.Response, error) {
	return r.ApiService.UpdateUserInfoExecute(r)
}

/*
UpdateUserInfo PUT: Update user info

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiUpdateUserInfoRequest
*/
func (a *UserAPIService) UpdateUserInfo(ctx context.Context) ApiUpdateUserInfoRequest {
	return ApiUpdateUserInfoRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return AddUserInfoSuccessResponseModel
func (a *UserAPIService) UpdateUserInfoExecute(r ApiUpdateUserInfoRequest) (*AddUserInfoSuccessResponseModel, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserAPIService.UpdateUserInfo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
