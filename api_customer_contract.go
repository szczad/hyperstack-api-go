...
type ApiDetailsOfContractByIDForCustomerRequest struct {
	ctx context.Context
	ApiService *CustomerContractAPIService
	contractId int32
}

func (r ApiDetailsOfContractByIDForCustomerRequest) Execute() (*CustomerContractDetailResponseModel, *http.Response, error) {
	return r.ApiService.DetailsOfContractByIDForCustomerExecute(r)
}
...
DetailsOfContractByIDForCustomer Retrieve Contract Details
 ...
 @param contractId
 @return ApiDetailsOfContractByIDForCustomerRequest
*/
func (a *CustomerContractAPIService) DetailsOfContractByIDForCustomer(ctx context.Context, contractId int32) ApiDetailsOfContractByIDForCustomerRequest {
	return ApiDetailsOfContractByIDForCustomerRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *CustomerContractAPIService) DetailsOfContractByIDForCustomerExecute(r ApiDetailsOfContractByIDForCustomerRequest) (*CustomerContractDetailResponseModel, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomerContractAPIService.DetailsOfContractByIDForCustomer")
	if err != nil {
